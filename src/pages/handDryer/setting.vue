<template>
  <view class="page">
    <view class="page-bg">
      ...
      <view class="card settings-card">
        ...
        <view class="list">
          ...
          <view class="list-item">
            ...
            <view class="extra value">
              <up-picker-data v-model="flowModeValue" title="请选择风量模式" :options="flowOptions" valueKey="id"
                labelKey="label" @confirm="confirmFlowMode">
      ...
      <!-- 风温弹窗 -->
      <up-popup :show="showWindWarmPopup" :round="10" mode="bottom" :closeOnClickOverlay="false"
      ...
      <!-- 感应自动关闭时间 -->
      <up-popup :show="showSenseAutoCloseTimePopup" :round="10" mode="bottom" :closeOnClickOverlay="false"
